...
* How a program makes a computer do stuff, at the level of electronics and stuff
  ...
  - Take the current set of (8, say) input voltages and save them on a bunch of other internal
    ...
    - We design these flip-flops to be super-response and fast (which also makes them expensive), and we
      call them "registers" because they register (save) data.  Like a cash register, which is all
      mechanical:  you push a key and a flag pops up and stays up, until you push another key to
      lower the flag.
...
* Compilers
  ...
  - Pascal :: For people who tired of immense blobs of BASIC code.
...
*** A tiny bit about Haskell
    ...
    where Haskell research and language compiler development takes place place is the University of
...
** Functions (Simplest)
  ...
  So, if we were to apply the function =c= to value 22 (°F), it would look like this:
...
** Function application is highest priority
...
this.page.url = "http://tarheel-nc.s3-website-us-east-1.amazonaws.com/Haskell/beginners-guide-to-haskell.html";  // Replace PAGE_URL with your page's canonical URL variable
this.page.identifier = "tarheel-nc/haskell-beginners-guide"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
};

(function() { // DON'T EDIT BELOW THIS LINE
var d = document, s = d.createElement('script');
s.src = 'https://tarheel-nc.disqus.com/embed.js';
