...
* DONE Data type constructors, conditionals, guards, pattern-matching, and more function stuff
  ...
  This sounds like an odd combination of topics, but bear with me.  (TODO: Actually, maybe can split the conditionals
  and guards stuff out into a separate topic.)
