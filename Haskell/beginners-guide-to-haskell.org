...
#+HTML_HEAD: <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans:400,400i,600,600i" rel="stylesheet">
...
* IN-PROGRESS Currying (Function application is highest priority)
  ...
  But here's some special Haskell weirdness: you don't have to supply every argument to a function.
  ...
  TODO: all of the following (including lambda expressions) is interesting but irrelevant.  Move it.

  It turns out that functions are "first class" values in their own right, meaning you can sling
  ...
  What's the argument here?  A function!
  ...
  The square root of 2 is 1.414.  And the reciprocal of 2 is 1/2.  =sqrt= and =recip= are built-in
...
** Lambda expressions
   ...
   So, we just applied a cubing function to 2.
